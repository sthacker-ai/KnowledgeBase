...
import type { WikiSummaryData } from "./WikiGrid";

const ROOT        = process.cwd();
const COURSES_DIR = path.join(ROOT, "content", "courses");

interface TopicSummary extends WikiSummaryData {}
...
function getSummaries(): TopicSummary[] {
  ...
  return fs
    ...
    .map((slug) => {
      ...
      return { slug, label, courseCount, excerpt, summarizedAt: fs.statSync(summaryPath).mtime.toISOString() };
    })
